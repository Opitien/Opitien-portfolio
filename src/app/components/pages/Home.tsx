      ...
      <div className="max-w-7xl w-full mx-auto grid lg:grid-cols-12 gap-8 lg:gap-16 items-center relative z-10">
        ...
        >
          ...
          <div className="space-y-6">
            ...
            {/* Name */}
            <h1 className="retro-heading text-[12vw] lg:text-[8rem] leading-[0.85] text-[#2C2C2C] tracking-tighter">
              OPITIEN
              <br />
              <span className="text-[#D17654]">EJIRO</span>
            </h1>
          ...
          <div className="flex flex-wrap gap-6 pt-4">
            ...
            <Link to="/works">
              <button className="retro-button group flex items-center gap-3 bg-[#2C2C2C] text-[#F5F3ED] hover:bg-[#D17654] hover:text-white border-none shadow-[4px_4px_0px_#5D9B99] transition-all">
            ...
            <Link to="/about">
              <button className="retro-button outline border-2 border-[#2C2C2C] hover:bg-[#2C2C2C] hover:text-[#F5F3ED] shadow-[4px_4px_0px_rgba(0,0,0,0.1)] transition-all">
        ...
        <div className="lg:col-span-5 relative h-[400px] lg:h-[600px] flex items-center justify-center lg:justify-end">
          ...
          >
            ...
            {/* Code Window */}
            <div className="absolute inset-8 bg-white border border-[#2C2C2C] p-6 shadow-xl z-20 overflow-hidden flex flex-col">
              ...
              <div className="font-mono text-xs text-[#2C2C2C]/60 space-y-1">
                ...
                <p>
                  <span className="text-[#D17654]">const</span> portfolio =
                  <span className="text-[#5D9B99]"> new</span> Creative();
                </p>

                <p>
                  portfolio.
                  <span className="text-[#D17654]">init</span>(
                  <span className="text-[#5D9B99]">'retro-mode'</span>);
                </p>

                <p className="pl-4 text-[#2C2C2C]/40">
                  // Loading assets...
                </p>
