        ...
        >
          <div className="relative aspect-[4/5] bg-card border border-border overflow-hidden">
            ...
            <img
              ...
              alt="Opitien Ejiro"
              className="w-full h-full object-cover filter contrast-[1.05] grayscale hover:grayscale-0 transition-all duration-700 ease-in-out scale-105 group-hover:scale-100"
            />
