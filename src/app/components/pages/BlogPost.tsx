...
export function BlogPost() {
  ...
  if (!post) {
    return (
      <div className="min-h-screen py-20 px-6 lg:px-12 bg-[#F5F3ED] text-center">
        <h1 className="retro-heading text-5xl text-[#2C2C2C]">
          Article Not Found
        </h1>
        <Link to="/blog" className="retro-button inline-flex mt-6 items-center gap-2">
